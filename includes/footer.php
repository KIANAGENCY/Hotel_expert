        ...
        <div class="grid gap-12 lg:grid-cols-12">
            ...
            <div class="lg:col-span-3">
                ...
                <div class="mt-7 space-y-3">
                    ...
                    <a class="footer-contact" href="mailto:<?= e(EMAIL_VENTAS) ?>">Correo</a>
                </div>
...
?>
<script>window.ELAH_BASE = <?= json_encode(BASE_URL, JSON_UNESCAPED_SLASHES) ?>; window.ELAH_WHATSAPP = <?= json_encode(WHATSAPP) ?>; window.ELAH_PRODUCTS = <?= json_encode($cartData, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES) ?>;</script>
